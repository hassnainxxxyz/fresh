                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="footer-logo">
                                    <a href="/temp/index.html">E-Commerce</a>
                                </div>
                            </div>
                            <div class="col-12">
                                <address>
                            ...
                            <div class="col-12">
                                <a href="/temp/#" class="social-icon"><i class="fab fa-facebook-f"></i></a>
                                <a href="/temp/#" class="social-icon"><i class="fab fa-twitter"></i></a>
                                <a href="/temp/#" class="social-icon"><i class="fab fa-pinterest-p"></i></a>
                                <a href="/temp/#" class="social-icon"><i class="fab fa-instagram"></i></a>
                                <a href="/temp/#" class="social-icon"><i class="fab fa-youtube"></i></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <ul class="footer-nav">
                                    ...
                                    <li>
                                        <a href="/temp/#">Contact Us</a>
                                    </li>
                                    <li>
                                        <a href="/temp/#">About Us</a>
                                    </li>
                                    <li>
