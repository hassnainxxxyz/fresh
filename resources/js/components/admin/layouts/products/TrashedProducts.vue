    ...
    <div>
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Trashed Products </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <div class="row justify-content-end"><div class="col-sm-12">
                        ...
                        <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                            ...
                            <tr role="row" class="even" v-for="product in theLaravelData.data" :key="product.id">
                                ...
                                <td>
                                    <button  @click="restore(product.slug)" style="font-size: 55%;" class="btn btn-sm btn-success">Restore</button>
                                    <button @click="forceDelete(product.slug)" style="font-size: 55%;" class="btn btn-sm btn-danger">Delete</button>
                                </td>
    ...
    export default {
        ...
        methods: {
            restore(slug) {
              axios({
                  method: 'get',
                  url: APIURL+'/api/products/'+slug+'/restore',
                  headers: {
            ...
            forceDelete(slug) {
                axios({
                    method: 'get',
                    url: APIURL+'/api/products/'+slug+'/force-delete',
                    headers: {
                        'authorization': "Bearer "+localStorage.getItem('token'),
            ...
            getResults(page = 1) {
                axios({
                    method: 'get',
                    url: APIURL+'/api/products/get-trashed-products?page='+page+"&limit="+this.limit+"&search="+this.finder,
                    headers: {
                        'authorization': "Bearer "+localStorage.getItem('token'),
                    },
                })
